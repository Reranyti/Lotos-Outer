...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> INFECTED_SOIL = BLOCKS.register("infected_soil", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).strength(0.6f).sound(SoundType.GRASS)));
    public static final RegistryObject<Block> LOTUS_STONE = BLOCKS.register("lotus_stone", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).strength(1.5f).sound(SoundType.STONE)));
    public static final RegistryObject<Block> LOTUS_SAND = BLOCKS.register("lotus_sand", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PINK).strength(0.5f).sound(SoundType.SAND)));
    public static final RegistryObject<Block> LOTUS_TERRACOTTA = BLOCKS.register("lotus_terracotta", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PINK).strength(1.25f).sound(SoundType.STONE)));
    public static final RegistryObject<Block> LOTUS_GRAVEL = BLOCKS.register("lotus_gravel", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GRAY).strength(0.6f).sound(SoundType.GRAVEL)));
    ...
    public static final RegistryObject<Block> BLOSSOM_GRASS = BLOCKS.register("blossom_grass", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_GREEN).strength(0.4f).sound(SoundType.GRASS)));
    public static final RegistryObject<Block> GLOW_BERRIES = BLOCKS.register("glow_berries", () -> new GlowBerryBushBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_YELLOW).strength(0.1f).sound(SoundType.GRASS).lightLevel(state -> 8).noCollission().noOcclusion()));
