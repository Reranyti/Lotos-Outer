...
public final class ModBlocks {
    ...
    public static final RegistryObject<Block> LOTUS_SAND = BLOCKS.register("lotus_sand", () -> new com.lotusblight.world.InfectedFallingGroundBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PINK).strength(0.5f).sound(SoundType.SAND)));
