...
public final class InfectionPhases {
    ...
    private static final int[] SPREAD_RADIUS = {0, 1, 2, 3, 3};

    /** Spread attempts performed per active outbreak per engine tick. */
    private static final int[] ATTEMPTS_PER_TICK = {0, 1, 2, 3, 4};
